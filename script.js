...
const stops = [ 
    ...
    { name: "Nagan Chowrangi", lat: 24.965847, lng: 67.067172 },
...
// Show waiting overlay when driver hasn't started
function showWaitingOverlay() {
    ...
    if (liveIndicator) {
        liveIndicator.style.background = 'rgba(158, 158, 158, 0.9)';
        liveIndicator.innerHTML = '<span class="pulse"></span>OFFLINE';
    }
}

// Hide waiting overlay when driver starts
...
function updateBusLocation(data) {
    ...
    // Route is active, hide waiting overlay
    hideWaitingOverlay();
